...
export const hi: PhrasePack = {
  ...
  ui: {
    ...
    introTagline: 'न्यू साउथ वेल्स की आधिकारिक जंगल की आग की चेतावनी, आपकी भाषा में और आसान शब्दों में।',
    introChooseLanguage: 'अपनी भाषा चुनें',
    introForTitle: 'यह ऐप आपके लिए है, अगर:',
    introForLanguage: 'आप अंग्रेज़ी आसानी से नहीं पढ़ पाते',
    introForText: 'आपको बड़े अक्षर चाहिए, या चेतावनी सुनकर समझना आसान लगता है',
    introForHelp: 'घर छोड़ने के लिए आपको किसी की मदद चाहिए',
