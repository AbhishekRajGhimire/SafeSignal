...
export const ar: PhrasePack = {
  ...
  ui: {
    ...
    switchToDemo: 'الوضع التجريبي',
    otherServices: 'أرقام هواتف أخرى',
    kmAway: 'كم',
    ...
    introTagline: 'تحذيرات حرائق الغابات الرسمية في نيو ساوث ويلز، بلغتك وبكلمات بسيطة.',
    introChooseLanguage: 'اختر لغتك',
    introForTitle: 'هذا التطبيق لك إذا:',
    introForLanguage: 'كنت لا تقرأ الإنجليزية بسهولة',
    introForText: 'كنت تحتاج خطًا أكبر، أو تحتاج قراءة التحذيرات بصوت عالٍ',
    introForHelp: 'كنت تحتاج مساعدة لمغادرة منزلك',
